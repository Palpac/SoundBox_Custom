    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (res_id == R.id.action_1)
        {
            ...
            my_builder
                    ...
                    //    }
                    //})
                    .setMessage(Html.fromHtml("Appuyer sur un bouton pour jouer le son.<P>Appuie long sur un bouton pour accéder au paramètres : son, image, libellé, enregistrement.<P>Crédits : Freepik.com<P><a href=\"http://davidpalpacuer.free.fr/SoundBoxCustom_PolitiqueConfidentialite.txt\">Politique de confidentialité</a>"))
            ...
            alert.show();
            ((TextView)alert.findViewById(android.R.id.message)).setMovementMethod(LinkMovementMethod.getInstance()); // Set link clickable, use after "alert.show();"
        }
        return true;
    }
